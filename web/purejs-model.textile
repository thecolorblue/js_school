...
Commerce! You can probably think of some things this model can do. Be added to a cart. Added to a meal. we could at it do a catalog of products. 
...
<pre>
	...
	xhr.send(JSON.strinify(product));
</pre>